...
//////////////////////////////////////// wifi client object creation /////////////////////////
WiFiClient client;
const char* ssid     = "ssis";             // Change here Network credentials Name
const char* password = "password";           //chnage here Network credentials Password
const char* Srver = "api.thingspeak.com";        // Server Name
String apiKey = "XXXXXXXXXXXXXXX";              // Write Api key
...
void BUTTON()
{
  ...
  if (st == HIGH && touch == 0)
  {
    ...
    Serial.print("Your Token Number    ");
