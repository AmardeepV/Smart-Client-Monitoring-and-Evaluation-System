 ...
 * If you want then you can also change the server.
...
int DIN = 16; // D0            // DIN pin of led matrix to D0 of nodemcu
int CS =  5;  // D1            // CS pin of led matrix to D1 of nodemcu
int CLK = 4;  // D2            // CLK pin of led matrix to D2 of nodemcu
byte devices = 2;                // Number of led matrix
int Buzzer = 14; // D5      // buzzer is connected to pin D5 of nodemcu
int counter = 0;             // variable
int buzzer_count = 0;          // variable
...
void setup ()
{
  ...
  http.begin("http://api.thingspeak.com/channels/302157/fields/1.json?results=1"); // replace your read a chennel feed url
